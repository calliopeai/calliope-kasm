# Calliope AI CLI Agent for Kasm Workspaces

Lightweight AI-powered terminal environment with the Calliope CLI agent pre-installed, powered by [Kasm Workspaces](https://kasmweb.com).
...
```bash
docker run --rm -it --shm-size=512m -p 6901:6901 -e VNC_PW=password calliopeai/calliope-base-kasm:latest
```
...
2. Docker Image: `calliopeai/calliope-base-kasm:latest`
...
Calliope AI CLI Agent is free to use. See [calliope.ai](https://calliope.ai) for terms.
